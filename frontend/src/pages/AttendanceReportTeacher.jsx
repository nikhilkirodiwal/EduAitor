...
function SummaryBar({ data, type }) {
    ...
    return (
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 mb-4">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-semibold text-slate-500 uppercase tracking-wide">Daily Summary</p>
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 mb-4">
      <div className="flex items-center justify-between mb-3">
        <p className="text-sm font-semibold text-slate-500 uppercase tracking-wide">Monthly Summary</p>
      ...
      <div className="flex gap-2 flex-wrap">
        <StatPill label="Students" value={totalStudents} color="bg-slate-50 border-slate-200 text-slate-700" />
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-2xl mx-auto px-3 py-5 sm:px-6 sm:py-8">
        ...
        <div className="mb-5">
          ...
          <p className="text-sm text-slate-400 mt-0.5">View attendance by class &amp; subject</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-5 mb-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <p className="col-span-2 text-xs text-slate-400 -mt-1">
              Pick <span className="font-semibold text-slate-600">a date</span> for daily or{" "}
              <span className="font-semibold text-slate-600">month + year</span> for monthly
            </p>

            <div className="col-span-2 flex flex-col gap-1">
              <label className="text-xs font-semibold text-slate-500 uppercase tracking-wide pl-1">Date</label>
              <input
                type="date"
                value={selDate}
          ...
          <div className="flex gap-2 mt-4">
            <button
              onClick={fetchReport}
              disabled={loading}
              className="flex-1 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:opacity-60
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
                <div>
                  ...
                  {modeLabel && <p className="text-xs text-slate-400">{modeLabel}</p>}
                </div>
        ...
        {!hasFetched && (
          <div className="text-center py-16">
            ...
            <p className="text-sm text-slate-500">Select filters and tap <strong>View Report</strong></p>
          </div>
        )}
