            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {hasChanges && !isEditMode && (
                <button
                  ...
                  className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-xs sm:text-sm font-semibold px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl transition"
                >
                  <FaSave size={12} />
              ...
              {isEditMode ? (
                <>
                  ...
                  {savedPeriodConfigs.length > 0 && (
                    <button
                      onClick={cancelEdit}
                      className="flex items-center gap-2 bg-gray-100 hover:bg-gray-200 text-gray-600 text-xs sm:text-sm font-semibold px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl transition"
                    >
                      <FiX size={12} />
                      <span>Cancel</span>
                    </button>
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs sm:text-sm font-semibold px-4 py-2 sm:px-5 sm:py-2.5 rounded-xl transition"
                >
                  <FaEdit size={12} />
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
              {periodConfigs.map((p, idx) => (
                <div
                  key={p.id}
                  className="relative group bg-gray-50 border border-gray-200 rounded-xl p-3 space-y-2"
                >
                  {/* delete */}
                  <button
                  ...
                  <input
                    ...
                    className="text-[10px] font-bold text-indigo-500 uppercase w-full bg-transparent border-none p-0 focus:outline-none"
                  />
                  <input
                    type="time"
                    value={p.start}
                    ...
                    className="text-xs w-full px-2 py-1 rounded-lg border border-gray-200 focus:outline-none focus:border-indigo-400"
                  />
                  <input
                    type="time"
                    value={p.end}
          ...
          <div>
            <h3 className="text-sm font-bold text-gray-700 flex items-center gap-2 mb-4">
              <MdOutlineClass className="text-indigo-500" />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5">
              {DAYS.map((day) => (
                ...
                >
                  <div className="bg-gray-800 text-white px-4 py-3 text-xs font-bold uppercase tracking-widest text-center">
                    {day}
                  </div>
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <select
                              ...
                              className="text-[10px] font-bold border border-gray-200 rounded-lg px-2 py-1 bg-white focus:outline-none"
                            >
                          ...
                          {data.type === "lecture" && (
                            <div className="space-y-1.5">
                              <select
                                ...
                                className="text-xs w-full px-2 py-1.5 border border-gray-200 rounded-lg bg-white focus:outline-none focus:border-indigo-400"
                              >
                ...
                >
                  ...
                  {DAYS.map((day) => {
                    ...
                    return (
                      <td
                        key={day}
                        className={`px-3 py-3 text-center align-top ${getCellStyle(data)}`}
                      >
                        {data?.type === "lecture" ? (
                          <div className="text-left space-y-1">
                            ...
                            {data.teacherId ? (
                              ...
                              <>
                                ...
                                <select
                                  className="text-[10px] border border-gray-200 rounded-lg px-1.5 py-1 w-full bg-white focus:outline-none"
                                  onChange={(e) =>
                                    updateAssignment(
                                      day,
                                      p.id,
                            ...
                            {data.status === "teacher-absent" && (
                              <div className="mt-1">
                                ...
                                <select
                                  className="text-[10px] border border-gray-200 rounded-lg px-1.5 py-1 w-full bg-white mt-1 focus:outline-none"
                                  onChange={(e) =>
                                    updateAssignment(
                                      day,
                                      p.id,
